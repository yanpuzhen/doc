...
// node_modules/.pnpm/vitepress-theme-website@1.0.6/node_modules/vitepress-theme-website/dist/waline/index.mjs
...
// node_modules/.pnpm/@waline+client@2.15.8/node_modules/@waline/client/dist/shim.mjs
...
var re = Q(["暱稱", "暱稱不能少於3個字元", "郵箱", "請填寫正確的郵件地址", "網址", "可選", "歡迎留言", "來發留言吧~", "送出", "喜歡", "取消喜歡", "回覆", "取消回覆", "留言", "重整", "載入更多...", "預覽", "表情", "上傳圖片", "秒前", "分鐘前", "小時前", "天前", "剛剛", "正在上傳", "登入", "登出", "管理者", "置頂", "字", "留言字數應在 $0 到 $1 字之間！\n目前字數：$2", "匿名", "潛水", "冒泡", "吐槽", "活躍", "多話", "傳說", "表情包", "搜尋表情包", "個人資料", "通過", "待審核", "垃圾", "取消置頂", "最早", "最新", "熱門", "你認為這篇文章怎麼樣？"]);
...
var ke = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/;
var Ce = (e2) => {
...
var $e = (e2, t2 = "", n2 = "", a = "") => `${t2 ? `${t2}/` : ""}${n2}${e2}${a ? `.${a}` : ""}`;
var Le = (e2) => {
  "AbortError" !== e2.name && console.error(e2.message);
};
var Re = (e2) => e2 instanceof HTMLElement ? e2 : "string" == typeof e2 ? document.querySelector(e2) : null;
var xe = (e2) => e2.type.includes("image");
var Ee = (e2) => {
  const t2 = Array.from(e2).find(xe);
...
var Ue = (e2, { emojiMap: t2, highlighter: n2, texRenderer: a }) => {
...
var Qe = {};
var et = {};
var tt = Ye && Ye.__awaiter || function(e2, t2, n2, a) {
...
var nt = Ye && Ye.__generator || function(e2, t2) {
...
Object.defineProperty(et, "__esModule", { value: true }), et.ReCaptchaInstance = void 0;
var at = function() {
...
et.ReCaptchaInstance = at, Object.defineProperty(Qe, "__esModule", { value: true }), Qe.getInstance = Qe.load = void 0;
var lt;
var rt = et;
!function(e2) {
...
var it = function() {
  ...
  return e2.load = function(t2, n2) {
    ...
    if (e2.getLoadingState() === lt.LOADED)
    ...
    if (e2.getLoadingState() === lt.LOADING)
    ...
    e2.instanceSiteKey = t2, e2.setLoadingState(lt.LOADING);
    var a = new e2();
    return new Promise(function(l, r2) {
      a.loadScript(t2, n2.useRecaptchaNet || false, n2.useEnterprise || false, n2.renderParameters ? n2.renderParameters : {}, n2.customUrl).then(function() {
        e2.setLoadingState(lt.LOADED);
        var r3 = a.doExplicitRender(grecaptcha, t2, n2.explicitRenderParameters ? n2.explicitRenderParameters : {}, n2.useEnterprise || false), i = new rt.ReCaptchaInstance(t2, r3, grecaptcha);
    ...
    return null === e2.loadingState ? lt.NOT_LOADED : e2.loadingState;
    ...
    return o2.src = s + "?render=explicit" + c, new Promise(function(t3, n3) {
      o2.addEventListener("load", i.waitForScriptToLoad(function() {
        ...
        e2.setLoadingState(lt.NOT_LOADED), n3(t4);
...
Qe.load = it.load, Qe.getInstance = it.getInstance, function(e2) {
...
var ot = {};
var st = null;
var ct = () => st ?? (st = useStorage("WALINE_USER", {}));
var ut = { key: 0, class: "wl-reaction" };
var dt = ["textContent"];
var vt = { class: "wl-reaction-list" };
var mt = ["onClick"];
var pt = { class: "wl-reaction-img" };
var gt = ["src", "alt"];
var ht = ["textContent"];
var ft = ["textContent"];
var yt = defineComponent({ __name: "ArticleReaction", setup(e2, { expose: t2 }) {
  t2();
  const y = Je(), w = inject("config"), b = ref(-1), k = ref([]), C = computed(() => w.value.locale), $ = computed(() => w.value.reaction.length > 0), L = computed(() => {
  ...
  }), onUnmounted(() => R == null ? void 0 : R()), (e3, t3) => L.value.length ? (openBlock(), createElementBlock("div", ut, [createBaseVNode("div", { class: "wl-reaction-title", textContent: toDisplayString(C.value.reactionTitle) }, null, 8, dt), createBaseVNode("ul", vt, [(openBlock(true), createElementBlock(Fragment, null, renderList(L.value, ({ active: e4, icon: t4, desc: n2 }, a) => (openBlock(), createElementBlock("li", { key: a, class: normalizeClass(["wl-reaction-item", { active: e4 }]), onClick: (e5) => (async (e6) => {
    if (-1 === b.value) {
  ...
  })(a) }, [createBaseVNode("div", pt, [createBaseVNode("img", { src: t4, alt: n2 }, null, 8, gt), b.value === a ? (openBlock(), createBlock(unref(Fe), { key: 0, class: "wl-reaction-loading" })) : (openBlock(), createElementBlock("div", { key: 1, class: "wl-reaction-votes", textContent: toDisplayString(k.value[a] || 0) }, null, 8, ht))]), createBaseVNode("div", { class: "wl-reaction-text", textContent: toDisplayString(n2) }, null, 8, ft)], 10, mt))), 128))])])) : createCommentVNode("v-if", true);
} });
var wt = (e2, t2) => {
...
var bt = wt(yt, [["__file", "ArticleReaction.vue"]]);
var kt = ["data-index"];
var Ct = ["src", "title", "onClick"];
var $t = wt(defineComponent({ __name: "ImageWall", props: { items: { default: () => [] }, columnWidth: { default: 300 }, gap: { default: 0 } }, emits: ["insert"], setup(e2, { expose: t2 }) {
  const n2 = e2;
  t2();
  let l = null;
  const o2 = ref(null), d = ref({}), p = ref([]), k = () => {
  ...
  }), onBeforeUnmount(() => l.unobserve(o2.value)), (e3, t3) => (openBlock(), createElementBlock("div", { ref_key: "wall", ref: o2, class: "wl-gallery", style: normalizeStyle({ gap: `${e3.gap}px` }) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(p.value, (t4, n3) => (openBlock(), createElementBlock("div", { key: n3, class: "wl-gallery-column", "data-index": n3, style: normalizeStyle({ gap: `${e3.gap}px` }) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(t4, (t5) => (openBlock(), createElementBlock(Fragment, { key: t5 }, [d.value[e3.items[t5].src] ? createCommentVNode("v-if", true) : (openBlock(), createBlock(unref(Fe), { key: 0, size: 36, style: { margin: "20px auto" } })), createBaseVNode("img", { class: "wl-gallery-item", src: e3.items[t5].src, title: e3.items[t5].title, loading: "lazy", onLoad: L, onClick: (n4) => e3.$emit("insert", `![](${e3.items[t5].src})`) }, null, 40, Ct)], 64))), 128))], 12, kt))), 128))], 4));
} }), [["__file", "ImageWall.vue"]]);
var Lt = { class: "wl-comment" };
var Rt = { key: 0, class: "wl-login-info" };
var xt = { class: "wl-avatar" };
var Et = ["title"];
var It = ["title"];
var jt = ["src"];
var At = ["title", "textContent"];
var St = { class: "wl-panel" };
var Ut = ["for", "textContent"];
var _t = ["id", "onUpdate:modelValue", "name", "type"];
var zt = ["placeholder"];
var Mt = { class: "wl-preview" };
var Ht = createBaseVNode("hr", null, null, -1);
var Tt = ["innerHTML"];
var Ot = { class: "wl-footer" };
var Pt = { class: "wl-actions" };
var Vt = { href: "https://guides.github.com/features/mastering-markdown/", title: "Markdown Guide", "aria-label": "Markdown is supported", class: "wl-action", target: "_blank", rel: "noopener noreferrer" };
var Dt = ["title"];
var Nt = ["title"];
var Bt = ["title"];
var Wt = ["title"];
var Ft = { class: "wl-info" };
var Kt = createBaseVNode("div", { class: "wl-captcha-container" }, null, -1);
var qt = { class: "wl-text-number" };
var Gt = { key: 0 };
var Zt = ["textContent"];
var Jt = ["textContent"];
var Yt = ["disabled"];
var Xt = ["placeholder"];
var Qt = { key: 1, class: "wl-loading" };
var en = { key: 0, class: "wl-tab-wrapper" };
var tn = ["title", "onClick"];
var nn = ["src", "alt"];
var an = { key: 0, class: "wl-tabs" };
var ln = ["onClick"];
var rn = ["src", "alt", "title"];
var on = ["title"];
var sn = defineComponent({ __name: "CommentBox", props: { edit: { default: null }, rootId: { default: "" }, replyId: { default: "" }, replyUser: { default: "" } }, emits: ["log", "cancelEdit", "cancelReply", "submit"], setup(e2, { expose: t2, emit: y }) {
  const w = e2;
  t2();
  const b = inject("config"), j = useStorage("WALINE_COMMENT_BOX_EDITOR", ""), A = useStorage("WALINE_USER_META", { nick: "", mail: "", link: "" }), S = ct(), U = ref({}), H = ref(null), T = ref(null), P = ref(null), V2 = ref(null), D2 = ref(null), N2 = ref(null), B2 = ref(null), W2 = ref({ tabs: [], map: {} }), F2 = ref(0), K2 = ref(false), q2 = ref(false), G2 = ref(false), Z2 = ref(""), J2 = ref(0), Y2 = reactive({ loading: true, list: [] }), X2 = ref(0), Q2 = ref(false), ee2 = ref(""), te2 = ref(false), ne2 = ref(false), ae2 = computed(() => b.value.locale), le2 = computed(() => {
    var _a;
    ...
    return ie2(t3), te2.value = true, Promise.resolve().then(() => b.value.imageUploader(e3)).then((n2) => {
...
![${e3.name}](${n2})`);
    ...
    if ((_a = e3.dataTransfer) == null ? void 0 : _a.items) {
      const t3 = Ee(e3.dataTransfer.items);
      t3 && re2.value && (se2(t3), e3.preventDefault());
    }
  }, ue2 = (e3) => {
    if (e3.clipboardData) {
      const t3 = Ee(e3.clipboardData.items);
      t3 && re2.value && se2(t3);
    }
  }, ve2 = () => {
    const e3 = T.value;
    ...
    })(), s = { comment: ee2.value, nick: A.value.nick, mail: A.value.mail, link: A.value.link, url: b.value.path, ua: o2 };
    if ((_a = S.value) == null ? void 0 : _a.token)
      s.nick = S.value.display_name, s.mail = S.value.email, s.link = S.value.url;
    else {
      if ("force" === n2)
        return;
      if (l.indexOf("nick") > -1 && !s.nick)
        return (_b = U.value.nick) == null ? void 0 : _b.focus(), alert(ae2.value.nickError);
      if (l.indexOf("mail") > -1 && !s.mail || s.mail && (c = s.mail, !ke.test(c)))
    ...
    if (s.comment) {
      ...
      try {
        r2 && (s.recaptchaV3 = await ((e4) => {
          const t4 = ot[e4] ?? (ot[e4] = Xe.load(e4, { useRecaptchaNet: true, autoHideBadge: true }));
          return { execute: (e5) => t4.then((t5) => t5.execute(e5)) };
        })(r2).execute("social")), i && (s.turnstile = await (u = i, { execute: async (e4) => {
          const { load: t4 } = useScriptTag("https://challenges.cloudflare.com/turnstile/v0/api.js", void 0, { async: false });
          await t4();
          const n4 = window == null ? void 0 : window.turnstile;
          return new Promise((t5) => {
            n4 == null ? void 0 : n4.ready(() => {
              n4 == null ? void 0 : n4.render(".wl-captcha-container", { sitekey: u, action: e4, size: "compact", callback: t5 });
            });
          });
        } }).execute("social"));
        const n3 = { serverURL: e3, lang: t3, token: (_d = S.value) == null ? void 0 : _d.token, comment: s }, a2 = await (w.edit ? de({ objectId: w.edit.objectId, ...n3 }) : (({ serverURL: e4, lang: t4, token: n4, comment: a3 }) => {
    ...
    (({ lang: e4, serverURL: t4 }) => {
      ...
      S.value = e4, (e4.remember ? localStorage : sessionStorage).setItem("WALINE_USER", JSON.stringify(e4)), y("log");
    });
  }, he2 = () => {
    S.value = {}, localStorage.setItem("WALINE_USER", "null"), sessionStorage.setItem("WALINE_USER", "null"), y("log");
  }, fe2 = (e3) => {
    e3.preventDefault();
    const { lang: t3, serverURL: n2 } = b.value, a = (window.innerWidth - 800) / 2, l = (window.innerHeight - 800) / 2, r2 = new URLSearchParams({ lng: t3, token: S.value.token }), i = window.open(`${n2}/ui/profile?${r2.toString()}`, "_blank", `width=800,height=800,left=${a},top=${l},scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no`);
    i == null ? void 0 : i.postMessage({ type: "TOKEN", data: S.value.token }, "*");
  }, ye2 = (e3) => {
    var _a, _b, _c, _d;
  ...
  return onMounted(() => {
    var _a;
    document.body.addEventListener("click", ye2), window.addEventListener("message", Le2), ((_a = w.edit) == null ? void 0 : _a.objectId) && (j.value = w.edit.orig), watch(q2, async (e3) => {
      if (!e3)
        return;
      ...
      ee2.value = e3, Z2.value = Ue(e3, { emojiMap: W2.value.map, highlighter: t3, texRenderer: n2 }), J2.value = ((e4) => {
        var _a2, _b;
      ...
      return (t3 = e3, Promise.all(t3.map((e4) => "string" == typeof e4 ? Ce(me(e4)) : Promise.resolve(e4))).then((e4) => {
        const t4 = { tabs: [], map: {} };
        return e4.forEach((e5) => {
          const { name: n2, folder: a, icon: l, prefix: r2, type: i, items: o2 } = e5;
          t4.tabs.push({ name: n2, icon: $e(l, a, r2, i), items: o2.map((e6) => {
            const n3 = `${r2 || ""}${e6}`;
            return t4.map[n3] = $e(e6, a, r2, i), n3;
          }) });
        }), t4;
      })).then((e4) => {
        W2.value = e4;
    ...
    document.body.removeEventListener("click", ye2), window.removeEventListener("message", Le2);
  }), (e3, t3) => {
    var _a, _b;
    return openBlock(), createElementBlock("div", Lt, ["disable" !== unref(b).login && le2.value && !((_a = e3.edit) == null ? void 0 : _a.objectId) ? (openBlock(), createElementBlock("div", Rt, [createBaseVNode("div", xt, [createBaseVNode("button", { type: "submit", class: "wl-logout-btn", title: ae2.value.logout, onClick: he2 }, [createVNode(unref(Me), { size: 14 })], 8, Et), createBaseVNode("a", { href: "#", class: "wl-login-nick", "aria-label": "Profile", title: ae2.value.profile, onClick: fe2 }, [createBaseVNode("img", { src: unref(S).avatar, alt: "avatar" }, null, 8, jt)], 8, It)]), createBaseVNode("a", { href: "#", class: "wl-login-nick", "aria-label": "Profile", title: ae2.value.profile, onClick: fe2, textContent: toDisplayString(unref(S).display_name) }, null, 8, At)])) : createCommentVNode("v-if", true), createBaseVNode("div", St, ["force" !== unref(b).login && unref(b).meta.length && !le2.value ? (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass(["wl-header", `item${unref(b).meta.length}`]) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(b).meta, (e4) => (openBlock(), createElementBlock("div", { key: e4, class: "wl-header-item" }, [createBaseVNode("label", { for: `wl-${e4}`, textContent: toDisplayString(ae2.value[e4] + (unref(b).requiredMeta.includes(e4) || !unref(b).requiredMeta.length ? "" : `(${ae2.value.optional})`)) }, null, 8, Ut), withDirectives(createBaseVNode("input", { id: `wl-${e4}`, ref_for: true, ref: (t4) => {
      t4 && (U.value[e4] = t4);
    }, "onUpdate:modelValue": (t4) => unref(A)[e4] = t4, class: normalizeClass(["wl-input", `wl-${e4}`]), name: e4, type: "mail" === e4 ? "email" : "text" }, null, 10, _t), [[vModelDynamic, unref(A)[e4]]])]))), 128))], 2)) : createCommentVNode("v-if", true), withDirectives(createBaseVNode("textarea", { id: "wl-edit", ref_key: "editorRef", ref: H, "onUpdate:modelValue": t3[0] || (t3[0] = (e4) => isRef(j) ? j.value = e4 : null), class: "wl-editor", placeholder: e3.replyUser ? `@${e3.replyUser}` : ae2.value.placeholder, onKeydown: oe2, onDrop: ce2, onPaste: ue2 }, null, 40, zt), [[vModelText, unref(j)]]), withDirectives(createBaseVNode("div", Mt, [Ht, createBaseVNode("h4", null, toDisplayString(ae2.value.preview) + ":", 1), createBaseVNode("div", { class: "wl-content", innerHTML: Z2.value }, null, 8, Tt)], 512), [[vShow, G2.value]]), createBaseVNode("div", Ot, [createBaseVNode("div", Pt, [createBaseVNode("a", Vt, [createVNode(unref(De))]), withDirectives(createBaseVNode("button", { ref_key: "emojiButtonRef", ref: P, type: "button", class: normalizeClass(["wl-action", { active: K2.value }]), title: ae2.value.emoji, onClick: t3[1] || (t3[1] = (e4) => K2.value = !K2.value) }, [createVNode(unref(Te))], 10, Dt), [[vShow, W2.value.tabs.length]]), unref(b).search ? (openBlock(), createElementBlock("button", { key: 0, ref_key: "gifButtonRef", ref: D2, type: "button", class: normalizeClass(["wl-action", { active: q2.value }]), title: ae2.value.gif, onClick: t3[2] || (t3[2] = (e4) => q2.value = !q2.value) }, [createVNode(unref(Ke))], 10, Nt)) : createCommentVNode("v-if", true), createBaseVNode("input", { id: "wl-image-upload", ref_key: "imageUploadRef", ref: T, class: "upload", type: "file", accept: ".png,.jpg,.jpeg,.webp,.bmp,.gif", onChange: ve2 }, null, 544), re2.value ? (openBlock(), createElementBlock("label", { key: 1, for: "wl-image-upload", class: "wl-action", title: ae2.value.uploadImage }, [createVNode(unref(Oe))], 8, Bt)) : createCommentVNode("v-if", true), createBaseVNode("button", { type: "button", class: normalizeClass(["wl-action", { active: G2.value }]), title: ae2.value.preview, onClick: t3[3] || (t3[3] = (e4) => G2.value = !G2.value) }, [createVNode(unref(Ve))], 10, Wt)]), createBaseVNode("div", Ft, [Kt, createBaseVNode("div", qt, [createTextVNode(toDisplayString(J2.value) + " ", 1), unref(b).wordLimit ? (openBlock(), createElementBlock("span", Gt, [createTextVNode("  /  "), createBaseVNode("span", { class: normalizeClass({ illegal: !Q2.value }), textContent: toDisplayString(X2.value) }, null, 10, Zt)])) : createCommentVNode("v-if", true), createTextVNode("  " + toDisplayString(ae2.value.word), 1)]), "disable" === unref(b).login || le2.value ? createCommentVNode("v-if", true) : (openBlock(), createElementBlock("button", { key: 0, type: "button", class: "wl-btn", onClick: ge2, textContent: toDisplayString(ae2.value.login) }, null, 8, Jt)), "force" !== unref(b).login || le2.value ? (openBlock(), createElementBlock("button", { key: 1, type: "submit", class: "primary wl-btn", title: "Cmd|Ctrl + Enter", disabled: te2.value, onClick: pe2 }, [te2.value ? (openBlock(), createBlock(unref(Fe), { key: 0, size: 16 })) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createTextVNode(toDisplayString(ae2.value.submit), 1)], 64))], 8, Yt)) : createCommentVNode("v-if", true)]), createBaseVNode("div", { ref_key: "gifPopupRef", ref: N2, class: normalizeClass(["wl-gif-popup", { display: q2.value }]) }, [createBaseVNode("input", { ref_key: "gifSearchInputRef", ref: B2, type: "text", placeholder: ae2.value.gifSearchPlaceholder, onInput: t3[4] || (t3[4] = (...e4) => unref(be2) && unref(be2)(...e4)) }, null, 40, Xt), Y2.list.length ? (openBlock(), createBlock($t, { key: 0, items: Y2.list, "column-width": 200, gap: 6, onInsert: t3[5] || (t3[5] = (e4) => ie2(e4)), onScroll: we2 }, null, 8, ["items"])) : createCommentVNode("v-if", true), Y2.loading ? (openBlock(), createElementBlock("div", Qt, [createVNode(unref(Fe), { size: 30 })])) : createCommentVNode("v-if", true)], 2), createBaseVNode("div", { ref_key: "emojiPopupRef", ref: V2, class: normalizeClass(["wl-emoji-popup", { display: K2.value }]) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(W2.value.tabs, (e4, t4) => (openBlock(), createElementBlock(Fragment, { key: e4.name }, [t4 === F2.value ? (openBlock(), createElementBlock("div", en, [(openBlock(true), createElementBlock(Fragment, null, renderList(e4.items, (e5) => (openBlock(), createElementBlock("button", { key: e5, type: "button", title: e5, onClick: (t5) => ie2(`:${e5}:`) }, [K2.value ? (openBlock(), createElementBlock("img", { key: 0, class: "wl-emoji", src: W2.value.map[e5], alt: e5, loading: "lazy", referrerPolicy: "no-referrer" }, null, 8, nn)) : createCommentVNode("v-if", true)], 8, tn))), 128))])) : createCommentVNode("v-if", true)], 64))), 128)), W2.value.tabs.length > 1 ? (openBlock(), createElementBlock("div", an, [(openBlock(true), createElementBlock(Fragment, null, renderList(W2.value.tabs, (e4, t4) => (openBlock(), createElementBlock("button", { key: e4.name, type: "button", class: normalizeClass(["wl-tab", { active: F2.value === t4 }]), onClick: (e5) => F2.value = t4 }, [createBaseVNode("img", { class: "wl-emoji", src: e4.icon, alt: e4.name, title: e4.name, loading: "lazy", referrerPolicy: "no-referrer" }, null, 8, rn)], 10, ln))), 128))])) : createCommentVNode("v-if", true)], 2)])]), e3.replyId || ((_b = e3.edit) == null ? void 0 : _b.objectId) ? (openBlock(), createElementBlock("button", { key: 1, type: "button", class: "wl-close", title: ae2.value.cancelReply, onClick: t3[6] || (t3[6] = (t4) => e3.$emit(e3.replyId ? "cancelReply" : "cancelEdit")) }, [createVNode(unref(Me), { size: 24 })], 8, on)) : createCommentVNode("v-if", true)]);
  };
} });
var cn = wt(sn, [["__file", "CommentBox.vue"]]);
var un = ["id"];
var dn = { class: "wl-user", "aria-hidden": "true" };
var vn = ["src"];
var mn = { class: "wl-card" };
var pn = { class: "wl-head" };
var gn = ["href"];
...
var bn = ["textContent"];
var kn = ["textContent"];
var Cn = { class: "wl-comment-actions" };
var $n = ["title"];
var Ln = ["textContent"];
var Rn = ["title"];
var xn = { class: "wl-meta", "aria-hidden": "true" };
var En = ["data-value", "textContent"];
var In = ["data-value", "textContent"];
var jn = ["data-value", "textContent"];
var An = ["innerHTML"];
var Sn = { key: 1, class: "wl-admin-actions" };
var Un = { class: "wl-comment-status" };
var _n = ["disabled", "onClick", "textContent"];
var zn = { key: 3, class: "wl-quote" };
var Mn = wt(defineComponent({ __name: "CommentCard", props: { comment: {}, edit: { default: null }, rootId: {}, reply: { default: null } }, emits: ["log", "submit", "delete", "edit", "like", "status", "sticky", "reply"], setup(e2) {
  const t2 = e2, a = ["approved", "waiting", "spam"], r2 = inject("config"), i = Ge(), o2 = useNow(), y = ct(), w = computed(() => r2.value.locale), b = computed(() => {
  ...
  return (e3, t3) => {
    var _a;
    const n2 = resolveComponent("CommentCard", true);
    return openBlock(), createElementBlock("div", { id: e3.comment.objectId, class: "wl-card-item" }, [createBaseVNode("div", dn, [e3.comment.avatar ? (openBlock(), createElementBlock("img", { key: 0, src: e3.comment.avatar }, null, 8, vn)) : createCommentVNode("v-if", true), e3.comment.type ? (openBlock(), createBlock(unref(We), { key: 1 })) : createCommentVNode("v-if", true)]), createBaseVNode("div", mn, [createBaseVNode("div", pn, [b.value ? (openBlock(), createElementBlock("a", { key: 0, class: "wl-nick", href: b.value, target: "_blank", rel: "nofollow noopener noreferrer" }, toDisplayString(e3.comment.nick), 9, gn)) : (openBlock(), createElementBlock("span", hn, toDisplayString(e3.comment.nick), 1)), "administrator" === e3.comment.type ? (openBlock(), createElementBlock("span", { key: 2, class: "wl-badge", textContent: toDisplayString(w.value.admin) }, null, 8, fn)) : createCommentVNode("v-if", true), e3.comment.label ? (openBlock(), createElementBlock("span", { key: 3, class: "wl-badge", textContent: toDisplayString(e3.comment.label) }, null, 8, yn)) : createCommentVNode("v-if", true), e3.comment.sticky ? (openBlock(), createElementBlock("span", { key: 4, class: "wl-badge", textContent: toDisplayString(w.value.sticky) }, null, 8, wn)) : createCommentVNode("v-if", true), void 0 !== e3.comment.level && e3.comment.level >= 0 ? (openBlock(), createElementBlock("span", { key: 5, class: normalizeClass(`wl-badge level${e3.comment.level}`), textContent: toDisplayString(w.value[`level${e3.comment.level}`] || `Level ${e3.comment.level}`) }, null, 10, bn)) : createCommentVNode("v-if", true), createBaseVNode("span", { class: "wl-time", textContent: toDisplayString($.value) }, null, 8, kn), createBaseVNode("div", Cn, [L.value || R.value ? (openBlock(), createElementBlock("button", { key: 0, type: "button", class: "wl-edit", onClick: t3[0] || (t3[0] = () => e3.$emit("edit", e3.comment)) }, [createVNode(unref(Be))])) : createCommentVNode("v-if", true), L.value || R.value ? (openBlock(), createElementBlock("button", { key: 1, type: "button", class: "wl-delete", onClick: t3[1] || (t3[1] = (t4) => e3.$emit("delete", e3.comment)) }, [createVNode(unref(He))])) : createCommentVNode("v-if", true), createBaseVNode("button", { type: "button", class: "wl-like", title: k.value ? w.value.cancelLike : w.value.like, onClick: t3[2] || (t3[2] = (t4) => e3.$emit("like", e3.comment)) }, [createVNode(unref(Pe), { active: k.value }, null, 8, ["active"]), "like" in e3.comment ? (openBlock(), createElementBlock("span", { key: 0, textContent: toDisplayString(e3.comment.like) }, null, 8, Ln)) : createCommentVNode("v-if", true)], 8, $n), createBaseVNode("button", { type: "button", class: normalizeClass(["wl-reply", { active: x.value }]), title: x.value ? w.value.cancelReply : w.value.reply, onClick: t3[3] || (t3[3] = (t4) => e3.$emit("reply", x.value ? null : e3.comment)) }, [createVNode(unref(Ne))], 10, Rn)])]), createBaseVNode("div", xn, [e3.comment.addr ? (openBlock(), createElementBlock("span", { key: 0, class: "wl-addr", "data-value": e3.comment.addr, textContent: toDisplayString(e3.comment.addr) }, null, 8, En)) : createCommentVNode("v-if", true), e3.comment.browser ? (openBlock(), createElementBlock("span", { key: 1, class: "wl-browser", "data-value": e3.comment.browser, textContent: toDisplayString(e3.comment.browser) }, null, 8, In)) : createCommentVNode("v-if", true), e3.comment.os ? (openBlock(), createElementBlock("span", { key: 2, class: "wl-os", "data-value": e3.comment.os, textContent: toDisplayString(e3.comment.os) }, null, 8, jn)) : createCommentVNode("v-if", true)]), E.value ? createCommentVNode("v-if", true) : (openBlock(), createElementBlock("div", { key: 0, class: "wl-content", innerHTML: e3.comment.comment }, null, 8, An)), L.value && !E.value ? (openBlock(), createElementBlock("div", Sn, [createBaseVNode("span", Un, [(openBlock(), createElementBlock(Fragment, null, renderList(a, (t4) => createBaseVNode("button", { key: t4, type: "submit", class: normalizeClass(`wl-btn wl-${t4}`), disabled: e3.comment.status === t4, onClick: (n3) => e3.$emit("status", { status: t4, comment: e3.comment }), textContent: toDisplayString(w.value[t4]) }, null, 10, _n)), 64))]), L.value && !e3.comment.rid ? (openBlock(), createElementBlock("button", { key: 0, type: "submit", class: "wl-btn wl-sticky", onClick: t3[4] || (t3[4] = (t4) => e3.$emit("sticky", e3.comment)) }, toDisplayString(e3.comment.sticky ? w.value.unsticky : w.value.sticky), 1)) : createCommentVNode("v-if", true)])) : createCommentVNode("v-if", true), x.value || E.value ? (openBlock(), createElementBlock("div", { key: 2, class: normalizeClass({ "wl-reply-wrapper": x.value, "wl-edit-wrapper": E.value }) }, [createVNode(cn, { edit: e3.edit, "reply-id": (_a = e3.reply) == null ? void 0 : _a.objectId, "reply-user": e3.comment.nick, "root-id": e3.rootId, onLog: t3[5] || (t3[5] = (t4) => e3.$emit("log")), onCancelReply: t3[6] || (t3[6] = (t4) => e3.$emit("reply", null)), onCancelEdit: t3[7] || (t3[7] = (t4) => e3.$emit("edit", null)), onSubmit: t3[8] || (t3[8] = (t4) => e3.$emit("submit", t4)) }, null, 8, ["edit", "reply-id", "reply-user", "root-id"])], 2)) : createCommentVNode("v-if", true), e3.comment.children ? (openBlock(), createElementBlock("div", zn, [(openBlock(true), createElementBlock(Fragment, null, renderList(e3.comment.children, (a2) => (openBlock(), createBlock(n2, { key: a2.objectId, comment: a2, reply: e3.reply, edit: e3.edit, "root-id": e3.rootId, onLog: t3[9] || (t3[9] = (t4) => e3.$emit("log")), onDelete: t3[10] || (t3[10] = (t4) => e3.$emit("delete", t4)), onEdit: t3[11] || (t3[11] = (t4) => e3.$emit("edit", t4)), onLike: t3[12] || (t3[12] = (t4) => e3.$emit("like", t4)), onReply: t3[13] || (t3[13] = (t4) => e3.$emit("reply", t4)), onStatus: t3[14] || (t3[14] = (t4) => e3.$emit("status", t4)), onSticky: t3[15] || (t3[15] = (t4) => e3.$emit("sticky", t4)), onSubmit: t3[16] || (t3[16] = (t4) => e3.$emit("submit", t4)) }, null, 8, ["comment", "reply", "edit", "root-id"]))), 128))])) : createCommentVNode("v-if", true)])], 8, un);
  };
} }), [["__file", "CommentCard.vue"]]);
var Hn = "2.15.8";
var Tn = { "data-waline": "" };
var On = { class: "wl-meta-head" };
var Pn = { class: "wl-count" };
var Vn = ["textContent"];
var Dn = { class: "wl-sort" };
var Nn = ["onClick"];
var Bn = { class: "wl-cards" };
var Wn = { key: 1, class: "wl-operation" };
var Fn = ["textContent"];
var Kn = { key: 0, class: "wl-loading" };
var qn = ["textContent"];
var Gn = { key: 2, class: "wl-operation" };
var Zn = ["textContent"];
var Jn = { key: 3, class: "wl-power" };
var Yn = createBaseVNode("a", { href: "https://github.com/walinejs/waline", target: "_blank", rel: "noopener noreferrer" }, " Waline ", -1);
var Xn = defineComponent({ __name: "WalineComment", props: ["serverURL", "path", "meta", "requiredMeta", "dark", "commentSorting", "lang", "locale", "pageSize", "wordLimit", "emoji", "login", "highlighter", "texRenderer", "imageUploader", "search", "copyright", "recaptchaV3Key", "turnstileKey", "reaction"], setup(e2) {
  const t2 = e2, n2 = { latest: "insertedAt_desc", oldest: "insertedAt_asc", hottest: "like_desc" }, y = Object.keys(n2), w = ct(), b = Ge(), k = ref("loading"), $ = ref(0), L = ref(1), R = ref(0), x = computed(() => (({ serverURL: e3, path: t3 = location.pathname, lang: n3 = "undefined" == typeof navigator ? "en-US" : navigator.language, locale: a, emoji: l = N, meta: r2 = ["nick", "mail", "link"], requiredMeta: i = [], dark: o2 = false, pageSize: s = 10, wordLimit: c, imageUploader: u, highlighter: d, texRenderer: v, copyright: m = true, login: p = "enable", search: g, reaction: h2, recaptchaV3Key: f = "", turnstileKey: y2 = "", commentSorting: w2 = "latest", ...b2 }) => ({ serverURL: ge(e3), path: ve(t3), locale: { ...ie[n3] || ie[B], ..."object" == typeof a ? a : {} }, wordLimit: he(c), meta: D(r2), requiredMeta: D(i), imageUploader: fe(u, F), highlighter: fe(d, Y), texRenderer: fe(v, K), lang: Object.keys(ie).includes(n3) ? n3 : "en-US", dark: o2, emoji: "boolean" == typeof l ? l ? N : [] : l, pageSize: s, login: p, copyright: m, search: false !== g && ("object" == typeof g ? g : q(n3)), recaptchaV3Key: f, turnstileKey: y2, reaction: Array.isArray(h2) ? h2 : true === h2 ? W : [], commentSorting: w2, ...b2 }))(t2)), E = ref(x.value.commentSorting), j = ref([]), S = ref(null), U = ref(null), _ = computed(() => {
  ...
  }), onUnmounted(() => M == null ? void 0 : M()), (e3, t3) => (openBlock(), createElementBlock("div", Tn, [createVNode(bt), S.value ? createCommentVNode("v-if", true) : (openBlock(), createBlock(cn, { key: 0, onLog: P, onSubmit: Z2 })), createBaseVNode("div", On, [createBaseVNode("div", Pn, [$.value ? (openBlock(), createElementBlock("span", { key: 0, class: "wl-num", textContent: toDisplayString($.value) }, null, 8, Vn)) : createCommentVNode("v-if", true), createTextVNode(" " + toDisplayString(z.value.comment), 1)]), createBaseVNode("ul", Dn, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(y), (e4) => (openBlock(), createElementBlock("li", { key: e4, class: normalizeClass([e4 === E.value ? "active" : ""]), onClick: (t4) => ((e5) => {
    E.value !== e5 && (E.value = e5, P());
  })(e4) }, toDisplayString(z.value[e4]), 11, Nn))), 128))])]), createBaseVNode("div", Bn, [(openBlock(true), createElementBlock(Fragment, null, renderList(j.value, (e4) => (openBlock(), createBlock(Mn, { key: e4.objectId, "root-id": e4.objectId, comment: e4, reply: S.value, edit: U.value, onLog: P, onReply: V2, onEdit: G2, onSubmit: Z2, onStatus: J2, onDelete: Q2, onSticky: X2, onLike: ee2 }, null, 8, ["root-id", "comment", "reply", "edit"]))), 128))]), "error" === k.value ? (openBlock(), createElementBlock("div", Wn, [createBaseVNode("button", { type: "button", class: "wl-btn", onClick: P, textContent: toDisplayString(z.value.refresh) }, null, 8, Fn)])) : (openBlock(), createElementBlock(Fragment, { key: 2 }, ["loading" === k.value ? (openBlock(), createElementBlock("div", Kn, [createVNode(unref(Fe), { size: 30 })])) : j.value.length ? L.value < R.value ? (openBlock(), createElementBlock("div", Gn, [createBaseVNode("button", { type: "button", class: "wl-btn", onClick: O, textContent: toDisplayString(z.value.more) }, null, 8, Zn)])) : createCommentVNode("v-if", true) : (openBlock(), createElementBlock("div", { key: 1, class: "wl-empty", textContent: toDisplayString(z.value.sofa) }, null, 8, qn))], 64)), x.value.copyright ? (openBlock(), createElementBlock("div", Jn, [createTextVNode(" Powered by "), Yn, createTextVNode(" v" + toDisplayString(unref(Hn)), 1)])) : createCommentVNode("v-if", true)]));
} });
var Qn = wt(Xn, [["__file", "WalineComment.vue"]]);
var ea = (e2, t2) => {
  t2.forEach((t3, n2) => {
    t3.innerText = e2[n2].toString();
  });
};
var ta = ({ serverURL: e2, path: t2 = window.location.pathname, selector: n2 = ".waline-pageview-count", update: a = true, lang: l = navigator.language }) => {
  const r2 = new AbortController(), i = Array.from(document.querySelectorAll(n2)), o2 = (e3) => {
    const n3 = _e(e3);
    return null !== n3 && t2 !== n3;
  }, s = (n3) => (({ serverURL: e3, lang: t3, paths: n4, signal: a2 }) => ce({ serverURL: e3, lang: t3, paths: n4, type: ["time"], signal: a2 }).then((e4) => Array.isArray(e4) ? e4 : [e4]))({ serverURL: ge(e2), paths: n3.map((e3) => _e(e3) || t2), lang: l, signal: r2.signal }).then((e3) => ea(e3, n3)).catch(Le);
  if (a) {
    const n3 = i.filter((e3) => !o2(e3)), a2 = i.filter(o2);
    (c = { serverURL: ge(e2), path: t2, lang: l }, ue({ ...c, type: "time", action: "inc" })).then((e3) => ea(new Array(n3.length).fill(e3), n3)), a2.length && s(a2);
  } else
    s(i);
  var c;
  return r2.abort.bind(r2);
};
var na = ({ el: t2 = "#waline", path: n2 = window.location.pathname, comment: a = false, pageview: l = false, ...r2 }) => {
  const i = t2 ? Re(t2) : null;
  if (t2 && !i)
    throw new Error("Option 'el' do not match any domElement!");
  if (!r2.serverURL)
    throw new Error("Option 'serverURL' is missing!");
  const o2 = reactive({ ...r2 }), s = reactive({ comment: a, pageview: l, path: n2 }), c = i ? createApp(() => h(Qn, { path: s.path, ...o2 })) : null;
  c && c.mount(i);
  const u = watchEffect(() => {
    s.comment && ze({ serverURL: o2.serverURL, path: s.path, selector: "string" == typeof s.comment ? s.comment : void 0 });
  }), d = watchEffect(() => {
    s.pageview && ta({ serverURL: o2.serverURL, path: s.path, selector: "string" == typeof s.pageview ? s.pageview : void 0 });
  });
...
// node_modules/.pnpm/vitepress-theme-website@1.0.6/node_modules/vitepress-theme-website/dist/waline/components/Waline.mjs
import "F:/vitedocs/node_modules/.pnpm/@waline+client@2.15.8/node_modules/@waline/client/dist/waline.css";
...
// node_modules/.pnpm/vitepress-theme-website@1.0.6/node_modules/vitepress-theme-website/dist/live2d/components/live2d.mjs
import Live2d from "F:/vitedocs/node_modules/.pnpm/vitepress-theme-website@1.0.6/node_modules/vitepress-theme-website/dist/live2d/components/Live2dComponent.vue";
Live2d.init = (props) => {
  const container = document.createElement("div");
...
// node_modules/.pnpm/vitepress-theme-website@1.0.6/node_modules/vitepress-theme-website/dist/live2d/index.mjs
